...
##
## Every pin lists its PACKAGE_PIN and IOSTANDARD explicitly (no wildcards)
## so Vivado's UCIO-1 DRC can match every logical port to a physical LOC.
## ==============================================================
...
## ---------- OV7670 Camera ----------
## Parallel data bus (JC Pmod + a couple from JB)
...
## pin and is NOT a clock-capable (MRCC/SRCC) input.  Tell Vivado to allow
## routing it on a regular track, otherwise we get [Place 30-574]
## "CLOCK_DEDICATED_ROUTE" violations.  The frame buffer handles CDC via
## dual-clock BRAM so using a regular routing track is acceptable.
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets cam_pclk_IBUF]

## Group the camera-PCLK family and the system-clock family as asynchronous
## so STA does not chase false inter-clock paths (the frame buffer handles
## CDC internally).
